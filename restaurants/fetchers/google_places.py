...
class GooglePlacesFetcher(BaseFetcher):
    ...
    @staticmethod
    def _fetch_details(session: requests.Session, params: dict, place_name: str) -> dict:
            ...
            for zip_code in tqdm(zip_codes, desc="ZIP codes"):
                ...
                while True:
                    ...
                    for fut in as_completed(list(future_map)):
                        ...
                        hours_dict = normalize_hours(_parse_hours(opening_hours_raw)) if opening_hours_raw else {}
                        ...
                        enriched = {
                            ...
                            "Opening Hours": "; ".join(f"{d}: {t}" for d, t in hours_dict.items()) if hours_dict else None,
